  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      <button
        ...
        aria-label={ariaLabel}
        className={cn(
          "flex min-h-10 w-full cursor-pointer items-center justify-between gap-2 rounded-lg border bg-white px-3.5 py-2 text-left font-sans text-sm transition-colors",
          "focus:outline-none focus:ring-2 focus:ring-teal/15",
          invalid ? "border-terracotta focus:border-terracotta focus:ring-terracotta/15" : "border-teal/20 focus:border-teal",
      ...
      {open && (
        <ul
          ...
          tabIndex={-1}
          className="absolute z-50 mt-1.5 max-h-64 w-full overflow-y-auto rounded-lg border border-teal/15 bg-white py-1 shadow-lg"
        >
