// Ported from Lightswind's 3D Scroll Trigger component
// (https://lightswind.com/components/3d-scroll-trigger.md). A row of content
// that auto-scrolls sideways, and whose speed/direction is driven by how fast
// and which way the page itself is being scrolled — multiple rows can share
// one scroll-velocity reading via ThreeDScrollTriggerContainer so they react
// in lockstep while still auto-scrolling in independent directions.
"use client";
